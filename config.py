...
OWNER_ID = int(getenv("OWNER_ID", "7259894402"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/SHIV_KI_NAGRII")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/SHIV_KI_NAGRII")
